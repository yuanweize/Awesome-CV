...
RUNTIME_DIRECTORIES = (
    ...
    "archive/applications/profiles",
    "archive/applications/outputs",
    "archive/applications/legacy-bundles",
    "archive/applications/reapplication-batches",
    "archive/assets/portfolio",
    "archive/audits",
    "archive/conversations",
    "archive/golden-packs",
    "archive/repository-history",
    "archive/research",
    "output",
    "output/pdf",
