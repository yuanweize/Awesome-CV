...
|---|---|---|
| Career workflow | `skills/evidence-first-cv/scripts/` | Validate memory, select claims, manage manifests/ledger, audit public GitHub, archive private work, and report status |
