...
def build_context(
    ...
    lines = [
        ...
        "6. Reuse a selected approved Golden CV unchanged. Do not impose a new page",
        "   limit or regenerate its identity. Only when the Owner explicitly authorizes",
        "   a new or freeze-candidate Pack may drafting add a visible role-appropriate",
        "   Skills section with three to five compact groups backed by selected claim IDs.",
        ...
        "21. Re-reason this complete JD from first principles. Record the central",
        "    responsibility, hard gates, strongest proof claims, selected identity,",
        "    truthful JD terms to surface, and distracting facts to omit. A role family,",
    ...
    lines.extend(
        [
            ...
            "4. After confirmation, create vacancy-adaptive deliverables using only approved",
            "   claim IDs and reuse any selected approved Golden CV unchanged. If the Owner",
            "   explicitly authorized a new or freeze-candidate Pack, preserve one to three",
            "   approved identity anchors in the top third and map each visible skill row to",
            "   selected claim IDs in the private manifest.",
